...
function Index() {
  ...
  useEffect(() => {
    const storedName = localStorage.getItem('loggedInUser'); // 🛠 Fix: specify key name
  ...
  return (
    <>
      <div className="hero">
        ...
        <div className="hero d-flex justify-content-center align-items-center flex-column bg-light" style={{ minHeight: '50vh' }}>
  <h1 className="display-4 fw-bold text-white text-center">
         👋 Hello, <span className="text-warning">{userName}</span>!
  </h1>
